<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.master" AutoEventWireup="true" CodeBehind="order.aspx.cs" Inherits="test.order" %>
        ...
        <div class="order_content">
            ...
            <div class="order_item">
                ...
                <div style="font-size: small; float: left; width: auto; margin: 5px 0 5px 10px;">
                    <asp:LinkButton ID="lnk_address" runat="server" PostBackUrl="~/myhome/myallorder.aspx">[添加地址]</asp:LinkButton>
                </div>
                <div>
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                        DataSourceID="SqlDataSource1" DataTextField="联系方式" DataValueField="ContactId">
                    </asp:RadioButtonList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
                        
                        SelectCommand="SELECT ContactId, Addressee, address AS 联系地址, phone AS 联系方式, userid FROM contact WHERE (userid = @usrid)">
                        <SelectParameters>
        ...
        <div class="order_content ">
            <div class="order_item ">
                ...
                <asp:Repeater ID="Repeater1" runat="server">
                    <HeaderTemplate>
                        <div style="background-color:#1c5e55; color:#333333">所购商品</div>
                    </HeaderTemplate>
            ...
            <div class="order_item" style="height: 20px;">
                <span style="font-size: medium; font-family: 黑体; margin: 5px 0 5px 5px; float: left;
                    width: auto;">商品金额总计：<asp:Label ID="lblTotal" runat="server" Text="0"></asp:Label></span>&nbsp;
            </div>
            <div class="order_item" style="height: 30px; text-align: right">
                <asp:Button ID="Button1" runat="server" Text="生成订单" CssClass="btn " Height="37px"
