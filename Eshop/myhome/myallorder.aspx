<%@ Page Title="" Language="C#" MasterPageFile="~/myhome/myhome.master" AutoEventWireup="true" CodeFile="myallorder.aspx.cs" Inherits="myhome_myallorder" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="width:100%">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT orders.OrderId, orders.MemberId, orders.ContactId, orders.Total, orders.Status, orders.OrderDate, orders.PayDate, orders.DeliverDate, orders.ReceiptDate, contact.Addressee FROM contact INNER JOIN orders ON contact.ContactId = orders.ContactId WHERE (orders.MemberId = @memberid)">
            <SelectParameters>
