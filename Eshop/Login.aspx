<%@ Page Title="" Language="C#" MasterPageFile="~/Shop.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" %>
        ...
        <div class="row justify-content-center" >        
            <div class="col-12 col-sm-8 col-md-5 col-lg-4">
                <div class="form-container">
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnLogin" runat="server" Text="登录" CssClass="btn btn-primary btn-block"
                            OnClick="btnLogin_Click" />
                        <asp:Button ID="btnReg" runat="server" Text="立即注册" CssClass="btn btn-primary btn-block" />
                    </div>
                </div>
            </div>
        </div>
